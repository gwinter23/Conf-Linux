...
yum install nano java-17-openjdk tomcat openssl xorg-x11-server-Xvfb cifs-utils krb5-workstation openldap-clients cyrus-sasl-gssapi cyrus-sasl-ldap net-snmp-utils net-snmp policycoreutils-devel lshw -y 
